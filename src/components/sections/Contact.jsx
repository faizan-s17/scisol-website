      ...
      <div className="relative z-10 pt-10 pb-20 w-full">
        <Container>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 max-w-6xl mx-auto">
            {/* Left: Contact Info */}
            <div>
              <div className="card p-6 border border-white/10 shadow-lg">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-navy font-medium">Free DRAP / export pathway assessment available upon request</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-navy font-medium">Typical response within 1-2 business days</p>
                    </div>
                  </div>
                </div>
              </div>
